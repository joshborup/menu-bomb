...
class RestaurantRegister extends React.Component {
    constructor(){
        ...
        this.state = {
            ...
            firstName: '',
            lastName: '',
    // Everfocused will prevent the Input fields from defaulting to the error border before the user has inputted any value
            EverfocusedName: false,
            EverfocusedEmail: false,
            EverfocusedPhone: false,
            EverfocusedAddress1: false,
            EverfocusedAddress2: false,
